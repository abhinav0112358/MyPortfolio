...
const About = () => {
    ...
    const handleCopy = () => {
        navigator.clipboard.writeText(' singhabhinav24680@gmail.com');
        setHasCopied(true);
                    ...
                    <div className="grid-container">
                        <div className="rounded-3xl w-full sm:h-[326px] h-fit flex justify-center items-center">
                            <Globe
                                ...
                                labelsData={[{ lat: 40, lng: -100, text: 'India', color: 'white', size: 15 }]}
                            />
                        </div>
                        <div>
                    ...
                    <div className="grid-container">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="copy-container" onClick={handleCopy}>
                                ...
                                <p className="lg:text-xl md:text-xl font-medium text-gray_gradient text-white">singhabhinav24680@gmail.com</p>
                            </div>
                        </div>
                    </div>
                </div>
